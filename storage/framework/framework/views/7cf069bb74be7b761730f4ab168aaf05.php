                ...
                <div class="mb-3">
                    <label class="form-label">Repartidor</label>
                         ...
                         <select name="repartidor" class="form-control" required     >
                          <option value="">Seleccionado <?php echo e($pedido->repartidor); ?></option>
                             <?php $__currentLoopData = $repartidores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $repartidor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                                ...
                                                <option value="<?php echo e($repartidor->nombre); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sistemanuevo\resources\views/pedidos/edit.blade.php ENDPATH**/ ?>